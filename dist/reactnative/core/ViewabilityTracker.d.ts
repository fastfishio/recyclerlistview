...
export type TOnItemStatusChangedWithPercentage = ((all: Array<{
    index: number;
...
export default class ViewabilityTracker {
    ...
    onVisibleRowsChangedWithPercentage: TOnItemStatusChangedWithPercentage | null;
    ...
    private _calculateVisibilityPercentage;

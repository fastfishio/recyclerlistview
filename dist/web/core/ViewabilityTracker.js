...
var ViewabilityTracker = /** @class */ (function () {
    ...
    ViewabilityTracker.prototype._calculateVisibilityPercentage = function (itemRect) {
        ...
        var totalLength = this._isHorizontal ? itemRect.width : itemRect.height;
        if (totalLength === 0) {
            return 0;
        }
    ...
    ViewabilityTracker.prototype._fitAndUpdate = function (startIndex) {
        ...
        if (this.onVisibleRowsChangedWithPercentage) {
            var visibleIndexesWithPercentage = this._visibleIndexes.map(function (index) {
                var itemRect = _this._layouts[index];
                var visibilityPercentage = _this._calculateVisibilityPercentage(itemRect);
                return { index: index, visibilityPercentage: visibilityPercentage };
            });

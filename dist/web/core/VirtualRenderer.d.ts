...
export default class VirtualRenderer {
    ...
    private onVisibleItemsChangedWithPercentage;
    ...
    attachVisibleItemsListenerWithPercentage(callback: TOnItemStatusChangedWithPercentage): void;
    removeVisibleItemsListener(): void;
    removeVisibleItemsListenerWithPercentage(): void;
    ...
    private _onVisibleItemsChangedWithPercentage;
